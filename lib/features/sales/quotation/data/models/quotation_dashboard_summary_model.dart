...
class QuotationDashboardSummaryModel extends QuotationDashboardSummary {
  const QuotationDashboardSummaryModel({
  ...
  factory QuotationDashboardSummaryModel.fromJson(Map<String, dynamic> json) {
    final payload = _extractPayload(json);
    final summary = payload['summary'];
    final data = summary is Map<String, dynamic> ? summary : payload;
    return QuotationDashboardSummaryModel(
