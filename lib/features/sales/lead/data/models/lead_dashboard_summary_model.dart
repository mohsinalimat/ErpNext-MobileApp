...
class LeadDashboardSummaryModel extends LeadDashboardSummary {
  const LeadDashboardSummaryModel({
  ...
  factory LeadDashboardSummaryModel.fromJson(Map<String, dynamic> json) {
    final payload = _extractPayload(json);
    final summary = payload['summary'];
    final data = summary is Map<String, dynamic> ? summary : payload;
    return LeadDashboardSummaryModel(
