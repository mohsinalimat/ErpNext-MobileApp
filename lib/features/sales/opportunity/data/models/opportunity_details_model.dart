...
import 'opportunity_activity_model.dart';
import 'opportunity_follow_up_model.dart';

class OpportunityDetailsModel extends OpportunityDetails {
  ...
  factory OpportunityDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    return OpportunityDetailsModel(
      ...
      activityLog: activityRaw
          .whereType<Map<String, dynamic>>()
          .map(OpportunityActivityModel.fromJson)
          .toList(),
    );
  }
  ...
  static Map<String, dynamic> _buildDisplayData(Map<String, dynamic> root) {
    ...
    addValue('opportunity_from', status['opportunity_from'] ?? root['opportunity_from']);
    ...
    addValue('opportunity_amount', valueMap['opportunity_amount'] ?? root['opportunity_amount']);
