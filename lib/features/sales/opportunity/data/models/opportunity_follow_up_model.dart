...
class OpportunityFollowUpModel extends OpportunityFollowUp {
  const OpportunityFollowUpModel({
    required super.name,
  ...
  factory OpportunityFollowUpModel.fromJson(Map<String, dynamic> json) {
    return OpportunityFollowUpModel(
